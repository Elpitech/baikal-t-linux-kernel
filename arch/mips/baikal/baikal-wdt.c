...
static int be_wdt_enable(unsigned int cpu)
{
...
static int be_wdt_disable(unsigned int cpu)
{
	unsigned int mode = gic_read_wd_ctrl();
...
static int be_wdt_drv_probe(struct platform_device *pdev)
{
	...
	be_wdt.initial = WDT_SECONDS * be_wdt.freq;

	cpuhp_setup_state(CPUHP_AP_MIPS_GIC_TIMER_STARTING,
			  "AP_MIPS_GIC_TIMER_STARTING", be_wdt_enable,
			  be_wdt_disable);
