...
{
	const struct pcf85x63_config *config;
	...
	config = (const struct pcf85x63_config *)id->driver_data;
	if (!config)
		return -EINVAL;
...
static const struct i2c_device_id pcf85363_id[] = {
        { "pcf85263", (kernel_ulong_t)&pcf_85263_config },
        { "pcf85363", (kernel_ulong_t)&pcf_85363_config },
        {}
};
